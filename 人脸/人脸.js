...
function 画脸(眼睛方向, 小孩, 附加x偏移, 行1, 行2) {
  ...
  for (var i = 0; i < 左右.length; i++ ) {
    ...
    strokeWeight(2);
    stroke(82,63,35);
    ellipse(250 + 70 * 位置 + x偏移,240 + 五官位移 + y偏移,60,25);
    fill(74,44,0);
    noStroke();
    ellipse(250 + 70 * 位置 + x偏移 + 眼睛位移.x, 240 + 眼睛位移.y + 五官位移 + y偏移, 22,22);
    fill(0);
    noStroke();
    ellipse(250 + 70 * 位置 + x偏移 + 眼睛位移.x, 240 + 眼睛位移.y + 五官位移 + y偏移, 15,15);
    fill(255,249,250);
    noStroke();
    ellipse(245 + 70 * 位置 + x偏移 + 眼睛位移.x, 240 + 眼睛位移.y + 五官位移 + y偏移, 5,5);
  }
