...
fill(c);
noStroke();
ellipse(250 + x偏移,250,270,360);
//face
//左耳
ellipse(120 + x偏移,250,60,80);
//右耳
ellipse(380 + x偏移,250,60,80);
...
fill(200,80,80);
noStroke();
arc(235 + x偏移,360 - 五官位移,50,25,PI,0,CHORD);
arc(265 + x偏移,360 - 五官位移,50,25,PI,0,CHORD);
arc(250 + x偏移,365 - 五官位移,80,30,0,PI,CHORD);
//lips
