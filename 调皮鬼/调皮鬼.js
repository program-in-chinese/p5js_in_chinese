...
var 左上眉毛起始点 = [317, 446]
var 左上眉毛各点位移 = [[0, 0], [-8, -15], [0, -14], [-12, 4], [-5, 8], [-2, 21]]

var 左下眉毛起始点 = [316, 481]
var 左下眉毛各点位移 = [[0, 0], [-6, 0], [-19, 6], [11, 27], [14, 19], [6, -3], [-4, -32]]

function 左上眉毛() {
  noStroke();
  fill(眉毛颜色)
  画包络线(左上眉毛起始点, 左上眉毛各点位移);
}

function 左下眉毛() {
  noStroke();
  fill(眉毛颜色)
  画包络线(左下眉毛起始点, 左下眉毛各点位移);
}
...
function 右上眉毛() {
  noStroke();
  fill(眉毛颜色);
  画包络线(右上眉毛起始点, 右上眉毛各点位移);
}

var 右上眉毛起始点 = [388, 417]
var 右上眉毛各点位移 = [[0, 0], [8, -7], [13, 17], [-1, 11], [-16, 6], [-2, -10]]

var 右下眉毛起始点 = [395, 473]
var 右下眉毛各点位移 = [[0, 0], [10, 46], [3, 12], [8, -25], [2, -14], [0, -21]]

function 右下眉毛() {
  noStroke()
  fill(眉毛颜色);
  画包络线(右下眉毛起始点, 右下眉毛各点位移);
}
